            ...
            <div className="content-wrapper">
                <div className="header-section">
                    ...
                    <div className="description">
                        <p>welcome to the official webring for university of mary washington students.</p>
                        <p>
                            our campus is home to builders, writers, artists, researchers, organizers,
                            and people doing interesting work across disciplines. this is a place to
                            find other cool people at mary washington, a directory of the students who

...
(function() {
    ...
    const baseUrl = '${process.env.NEXT_PUBLIC_BASE_URL || 'https://www.umw.network'}';
    ...
    fetch(apiUrl)
        ...
        .then(data => {
            ...
            wrapper.className = 'umw-network-wrapper';
            const alignStyles = {
            ...
            container.id = 'umw-network';
            container.className = 'umw-network';
            ...
            centerLink.title = 'Visit umw.network';
